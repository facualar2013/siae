...
# Estilos CSS institucionales y ajuste visual para submenús desplegables
st.markdown(
    """
<style>
    .stApp {
...
# ==========================================
# MENÚ LATERAL: ESTRUCTURA CON SUBMENÚS
# ==========================================
with st.sidebar:
  ...
  # 2. Menú Desplegable: Asistencia (Submenús)
  with st.expander(
      "📋 **Asistencia**",
      expanded=(
...
if st.session_state.pantalla == "inicio":
  ...
  st.write("Seleccione un módulo desplegable en el menú lateral para operar.")
...
# 4. BUSCAR ALUMNOS
  ...
  st.title("🔍 Buscador de Alumnos")
  busqueda = st.text_input("Nombre o apellido:").strip().lower()
